define("#widget/0.9.17/widget-debug", ["#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "$", "#widget/0.9.17/daparser-debug", "#widget/0.9.17/auto-render-debug"], function(require, exports, module) {
    ...
    var $ = require("$");
    var DAParser = require("#widget/0.9.17/daparser-debug");
    var AutoRender = require("#widget/0.9.17/auto-render-debug");
