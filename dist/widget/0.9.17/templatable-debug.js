define("#widget/0.9.17/templatable-debug", ["$", "#handlebars/1.0.0/handlebars-debug", "#widget/0.9.17/ast-printer-debug"], function(require, exports, module) {

    var $ = require("$");
    var Handlebars = require("#handlebars/1.0.0/handlebars-debug");
    Handlebars.print = require("#widget/0.9.17/ast-printer-debug").print;
